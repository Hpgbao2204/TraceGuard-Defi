...
class HarmObservation:
    """Raw harm detection, independent of valuation/severity reporting."""

    status: str
    tier: str
    boundary_id: str
    observation_scope: str = "transaction"
    hard_deltas: dict[str, str] = field(default_factory=dict)
    exotic_deltas: dict[str, str] = field(default_factory=dict)
    liability_deltas: dict[str, str] = field(default_factory=dict)
    detection_source: str = ""
    detection_complete: bool = False
    quantified_usd: float | None = None
    valuation_status: str = "NOT_REQUIRED"

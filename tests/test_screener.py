...
class TestScreenerModelContract(unittest.TestCase):
    def test_constructor_requires_explicit_model(self):
        with self.assertRaises(ValueError):
            Screener()

    def test_demo_model_is_explicit(self):
        self.assertIsNotNone(Screener.demo().fusion)
